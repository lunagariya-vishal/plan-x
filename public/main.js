...
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
            ...
            var ReportComponent = /** @class */ (function () {
                ...
                ReportComponent.prototype.reportDetailsSubmit = function () {
                    ...
                    this.commonService.updateData('study/report/' + this.reportForm.controls['_id'].value, { 'ReportDetails': ExtraReportDetails }).subscribe(function (response) {
                        if (response.status) {
                ...
                ReportComponent.prototype.extraReportDetailsSubmit = function () {
                    ...
                    this.commonService.updateData('study/report/' + this.reportForm.controls['_id'].value, { 'ExtraReportDetails': ExtraExtraReportDetails }).subscribe(function (response) {
                        if (response.status) {
                            _this.errorLogService.handleSuccess(response.message);
                            // this.router.navigate(['/']);
                        }
